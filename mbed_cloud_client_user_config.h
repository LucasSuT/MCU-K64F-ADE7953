...
#define MBED_CLOUD_CLIENT_LIFETIME              3600
	...
	#endif
	//<sophie, choose TCP or UDP or UDP_QUEUE for mbed cloud client
	//#define MBED_CLOUD_CLIENT_TRANSPORT_MODE_TCP			// use TCP for _DEVICE_UBLOX_SARA_N410
	//#define MBED_CLOUD_CLIENT_TRANSPORT_MODE_UDP
	#define MBED_CLOUD_CLIENT_TRANSPORT_MODE_UDP_QUEUE	// use UDP_QUEUE for quectel device
	//>sophie, choose TCP or UDP or UDP_QUEUE for mbed cloud client
#endif
